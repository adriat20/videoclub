...
class FilmSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Film::insert([
            ...
            'category_id' => 1,
            'synopsis' => 'Randle McMurphy',
            'year' => '1975',
            'director' => 'Milos Forman',
            'poster' => 'Alguienvolo.jpg',
            'rented' => '8',
            //cuando monta una migracion siempre crea dos campos, created y updated. Al     estar insertandolo, si no lo pones te lo genera con null 
            'created_at'=>now(),
